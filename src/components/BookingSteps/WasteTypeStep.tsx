    ...
    >
        ...
        <div className='flex items-start'>
          ...
          <div className='ml-3'>
            ...
            <p className='text-sm text-slate-300'>
              Different waste types may have specific disposal requirements and pricing. 
              Select the category that best matches your waste to ensure proper handling.
            </p>
          </div>
        </div>
      </div>
              ...
              <div className='relative bg-gradient-to-br from-slate-700 via-slate-600 to-slate-700 p-5 sm:p-6'>
                <div className='flex items-center justify-between'>
                  <div className='flex items-center'>
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center transition-colors bg-gradient-to-r ${
                  ...
                  {isSelected && (
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center bg-gradient-to-r ${colors.gradient}`}>
                      <svg className='w-5 h-5 text-white' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                ...
                <div className='space-y-3 mb-5'>
                  ...
                  {examples.slice(0, 3).map((example: string, index: number) => (
                    <div key={index} className='flex items-center text-slate-300'>
                      <svg className={`w-4 h-4 mr-3 ${isSelected ? `text-${colors.gradient.split('-')[1]}-400` : 'text-slate-400'}`} fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                        <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M5 13l4 4L19 7' />
                      </svg>
      ...
      {selectedType && (
        <div className='bg-gradient-to-r from-slate-800/50 to-slate-700/50 border border-slate-600/50 rounded-xl p-6 mb-8 sm:mb-12'>
          ...
          <div className='flex items-center'>
            <div className={`w-10 h-10 rounded-full flex items-center justify-center mr-4 bg-gradient-to-r ${getWasteTypeColors(selectedType).gradient}`}>
