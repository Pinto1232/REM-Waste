        ...
        <div className='flex items-start'>
          ...
          <div className='ml-3'>
            ...
            <p className='text-sm text-slate-300'>
              A permit is required if the skip will be placed on a public road, pavement, or any council-owned land. 
              If placing on private property (driveway, garden), no permit is needed.
            </p>
          </div>
        </div>
      </div>
