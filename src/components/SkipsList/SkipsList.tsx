      ...
      {skips && skips.length > 0 && (
        <div className='mb-6 px-4 sm:px-0'>
          <p className='text-slate-400 text-sm'>
            {searchFilters && (searchFilters.searchTerm || searchFilters.sizeRange !== 'all' || searchFilters.priceRange !== 'all' || searchFilters.roadLegal !== 'all') ? (
              ...
              <div className='relative bg-gradient-to-br from-slate-700 to-slate-600 p-4'>
                <div className='flex items-center justify-between'>
                  <div className='flex items-center'>
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors bg-gradient-to-r ${
                    ...
                    <div className='ml-3'>
                      ...
                      <p className='text-slate-300 text-xs'>{skip.area} • {skip.postcode}</p>
                    </div>
                  </div>
                  {selectedSkipId === skip.id && (
              ...
              <div className='p-4'>
                ...
                <div className='space-y-2 mb-4'>
                  <div className='flex items-center text-xs'>
                    <svg className={`w-3 h-3 mr-2 ${skip.allowed_on_road ? 'text-green-400' : 'text-red-400'}`} fill='currentColor' viewBox='0 0 20 20'>
